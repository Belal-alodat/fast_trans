...
class AssignShipment extends StatefulWidget {
  ShipmentStatus _shipmentStatus;
    AssignShipment(this._shipmentStatus);
  @override
  _AssignShipmentState createState() => _AssignShipmentState();
}

class _AssignShipmentState extends State<AssignShipment> {
  List<Shipment> list = [];
  @override
