...
class ListShipment extends StatefulWidget {
  ShipmentStatus _shipmentStatus;
    ListShipment(this._shipmentStatus);
  @override
  _ListShipmentState createState() => _ListShipmentState();
}
 ...
 void didChangeDependencies() async {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      widget._shipmentStatus == ShipmentStatus.Customer_Submitted ?
      FloatingActionButton(
        onPressed: () async {
          //_counter++;
          await Navigator.pushNamed(context, '/shipment');
          setState(() {
            print('setState ');
          });
        },
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child:FutureBuilder<List<Shipment>>(
            future: Provider.of<CustomerProvider>(context, listen: false).getShipmentsWithStatus(widget._shipmentStatus),
    ...
    for (int i = 0; i < list!.length; i++) {
      ...
      children.add(InkWell(
          onTap: ()async {
            ...
            Navigator.pushNamed(context, '/Customer/UpdateShipmentPage',arguments:list[i] ).then((value) => setState(() {
            }))   ;
